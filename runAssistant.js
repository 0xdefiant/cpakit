  ...
  try {
    ...
    try {
      ...
      const assistantConfig = {
        name: "Tax Accountant Agent",
        instructions:
        "You're a Tax Accoutant, you must make sure that users comply with all tax laws.",
    ...
    console.log(
      `Hello there, I'm your personal Tax AI Agent. You gave me these instructions:\n${assistantDetails.instructions}\n`
    );
